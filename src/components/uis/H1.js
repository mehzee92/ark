...
function H1({text,variant="type_one"}) {
  var variants = {
    type_one: `text-xl w-160 m-auto text-center text-gray-50`,
    type_two: `text-xl lg:text-4xl text-gray-300`,
    type_three: `text-xl text-gray-300 font-extrabold`,
    textGradient: `text-xl bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-pink-500 font-extrabold`
  }
  return (
