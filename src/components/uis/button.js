const Button = ({ text, onClick, variant = 'info', type = 'button' }) => {
  ...
  var variants = {
    ...
    success: ` mx-1 my-1 rounded-lg cursor-pointer bg-gradient-to-r from-green-800 to-green-900 px-6 py-2 focus:outline-none transition hover:shadow-lg hover:shadow-green-700/25`,
