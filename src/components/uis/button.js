const Button = ({ text, onClick, variant = 'info', type = 'button' }) => {
  ...
  var variants = {
    ...
    success: ` mx-1 my-1 border border-1 border-green-100 rounded-lg cursor-pointer bg-gradient-to-r from-green-600 to-green-900 px-6 py-2 focus:outline-none transition hover:shadow-lg hover:shadow-green-700/25 text-lg lg:text-2xl`,
